...
public class UiActions {
	...
	private static final By VIGNETTE_CLOSE_BUTTON = By.xpath("//*[self::button or self::div or self::span]"
			+ "[normalize-space()='Close' or @aria-label='Close' or @title='Close']");

	private static final By VIGNETTE_OVERLAY = By
			.cssSelector("body > div[role='dialog'], iframe[id*='google'], iframe[src*='google']");
	...
	/**
	 * Click “safe”: 1) waits until the element is clickable and clicks normally 2)
	 * if something is covering it / constantly / intercept -> scroll + JS click
	 */
